...
public class SettingActivity extends BaseTitleActivity {
    ...
    void showOperatingCenter() {
        ...
        map.put("username", accoutBean.getUsername());
        showLoadingDialog();
...
//        });
    ...
    public void initVoicerVibrate() {
        try {
            ...
            e.printStackTrace();
            LogUtils.e(TAG, "initVoicerVibrate----Exception");
        }
    }
    ...
    private void updatePlantStorage() {
        ...
        if (null != accoutBean) {
            tvUsername.setText(accoutBean.getRealname());
            tv_operatingCenterSetting.setText(accoutBean.getPlant());
            OperatingCenterDialog.setCallBack(new OperatingCenterDialog.OperatingCenterCallBack() {
                ...
                public void operatingCenterCallBack(String choosePlant) {
                    try {
                        if (!accoutBean.getPlant().equals(choosePlant)) {
                            Connector.getDatabase();
                            accoutBean.setPlant(choosePlant);
                            tv_operatingCenterSetting.setText(accoutBean.getPlant());
                            accoutBean.update(accoutBean.getId());
                            getDefaultStorate(false);
                        }
                    } catch (Exception e) {
                        LogUtils.e(TAG, "updatePlantStorage---operatingCenterCallBack---Exception");
                    }
                }
            });
...
//        });
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            LogUtils.e(TAG, "unregisterReceiver------Exception");
        }
    ...
    BroadcastReceiver mBTReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                LogUtils.e(TAG, "new BroadcastReceiver()----报错");
            }
        }
    };
