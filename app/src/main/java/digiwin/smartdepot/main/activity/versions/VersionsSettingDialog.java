package digiwin.smartdepot.main.activity.versions;
...
import digiwin.smartdepot.core.net.IDownLoadCallBackImp;
...
//        dialogUtils.setCanceledOnTouchOutside();
        ...
        if(versionBean!=null){
            String verWhat = StringUtils.lineChange(versionBean.getVerwhat());
