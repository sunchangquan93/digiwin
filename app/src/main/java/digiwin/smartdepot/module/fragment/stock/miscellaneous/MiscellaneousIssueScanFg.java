        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case REASONCODEWHAT:
                    ...
                    reasonMap.put(AddressContants.BARCODE_NO, String.valueOf(msg.obj));
                ...
                case DEPARTMENTWHAT:
                    ...
                    departmentMap.put(AddressContants.BARCODE_NO, String.valueOf(msg.obj));
                    commonLogic.scanDepartmentCode(departmentMap, new CommonLogic.ScanDepartmentListener() {
                        @Override
                        public void onSuccess(ScanDepartmentBackBean barcodeBackBean) {
