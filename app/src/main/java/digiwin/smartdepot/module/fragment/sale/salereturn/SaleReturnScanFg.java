 ...
 * @des 销售退货 扫码页面
 */
public class SaleReturnScanFg extends BaseFragment {
    ...
    void Save() {
        ...
        final float qty = StringUtils.string2Float(saveBean.getQty());
        final float scansum_qty = StringUtils.string2Float(saveBean.getScan_sumqty());
