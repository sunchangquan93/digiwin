 ...
 * @des 采购收货 扫码页面
 */
public class PurchaseReceiveScanFg extends BaseFragment {
    ...
    void save() {
        ...
        saveBean.setStorage_spaces_in_no("");
        showLoadingDialog();
                ...
                case BARCODEWHAT:
                    ...
                    commonLogic.scanBarcode(barcodeMap, new CommonLogic.ScanBarcodeListener() {
                        ...
                        public void onSuccess(ScanBarcodeBackBean barcodeBackBean) {
                            ...
                            saveBean.setCustomer_no(barcodeBackBean.getCol3());
                            saveBean.setSeq(barcodeBackBean.getCol2());
    ...
    protected int bindLayoutId() {
        return R.layout.activity_purchase_receive_scan;
    }
