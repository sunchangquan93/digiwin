...
import digiwin.smartdepot.module.fragment.stock.miscellaneousactive.out.MiscellaneousActiveOutScanFg;
import digiwin.smartdepot.module.fragment.stock.miscellaneousactive.out.MiscellaneousActiveOutSumFg;

/**
 * 孙长权
 * 有源杂项发料
 */
public class MiscellaneousActiveOutActivity extends BaseFirstModuldeActivity {
    /**
     * 标题
     */
     ...
     * 条码扫描
     */
    public MiscellaneousActiveOutScanFg scanFg;
    /**
     * 数据汇总
     */
    MiscellaneousActiveOutSumFg sumFg;
    ...
    public String moduleCode() {
        module = ModuleCode.MISCELLANEOUSACTIVE_OUT;
        return module;
    }
    ...
    protected void initNavigationTitle() {
        ...
        mName.setText(R.string.miscellaneous_active_out);
    }
    ...
    private void initFragment() {
        scanFg = new MiscellaneousActiveOutScanFg();
        sumFg = new MiscellaneousActiveOutSumFg();
