 ...
 * 有源杂项发料
 */
public class MiscellaneousActiveOutListActivity extends BaseTitleActivity {
    /**
     * 标题
     */
    ...
    protected void doBusiness() {
        ...
        //动态设置字符
        tv_miscellaneous_in_no.setText(context.getResources().getString(R.string.miscellaneous_out_no));
    ...
    private void onItemClick() {
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int position) {
                ...
                ActivityManagerUtils.startActivityBundleForResult(activity, MiscellaneousActiveOutActivity.class, bundle, SUMCODE);
            }
        });
    }
    ...
    protected void initNavigationTitle() {
        ...
        mName.setText(getString(R.string.miscellaneous_active_out) + getString(R.string.list));
    ...
    public void upDateList() {
        ...
        adapter = new MiscellaneousActiveInAdapter(activity,true, sumShowBeanList);
