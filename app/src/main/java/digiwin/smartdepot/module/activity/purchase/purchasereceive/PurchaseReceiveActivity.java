package digiwin.smartdepot.module.activity.purchase.purchasereceive;
...
import digiwin.smartdepot.module.fragment.purchase.purchasereceive.PurchaseReceiveScanFg;
import digiwin.smartdepot.module.fragment.purchase.purchasereceive.PurchaseReceiveSumFg;

/**
 * @des 采购收货
 * Created by maoheng on 2017/7/4.
 */

public class PurchaseReceiveActivity extends BaseFirstModuldeActivity{
     ...
     * 扫码
     */
    public PurchaseReceiveScanFg scanFg;
    /**
     * 汇总提交
     */
    public PurchaseReceiveSumFg sumFg;
    ...
    protected int bindLayoutId() {
        return R.layout.activity_pruchase_receive;
    }
    ...
    private void initFragment() {
        ...
        scanFg = new PurchaseReceiveScanFg();
        sumFg = new PurchaseReceiveSumFg();
    ...
    protected void initNavigationTitle() {
        ...
        mName.setText(R.string.title_purchase_receive);
    }
