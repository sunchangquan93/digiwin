 ...
 * @author 唐孟宇
 */
public class PostMaterialSumActivity extends BaseFirstModuldeActivity{
    ...
    private void commitData() {
        ...
        commonLogic.commit(map, new CommonLogic.CommitListener() {
            ...
            public void onSuccess(String msg) {
                ...
                adapter = new PostMaterialSumAdapter(pactivity,new ArrayList<ListSumBean>());
     ...
     * 跳转扫描页使用
     */
    public final int SCANCODE = 1111;
    /**
     * 跳转明细使用
     */
    public final int DETAILCODE = 1112;

    CommonLogic commonLogic;

    PostMaterialSumActivity pactivity;
    ...
    protected int bindLayoutId() {
        return R.layout.activity_post_material_sum;
    }

    @Override
    protected void doBusiness() {
        pactivity = (PostMaterialSumActivity) activity;
    ...
    private void initData() {
        ...
        adapter = new PostMaterialSumAdapter(pactivity,sumDataList);
        ryList.setAdapter(adapter);
        ryList.setFocusable(false);
        orderData = (FilterResultOrderBean) getIntent().getExtras().getSerializable("orderData");
        tv_post_order.setText(orderData.getDoc_no());
        tv_plan_date.setText(orderData.getCreate_date());
    ...
    public void onItemClick(){
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int position) {
                ...
                ActivityManagerUtils.startActivityBundleForResult(pactivity,PostMaterialScanActivity.class,bundle,SCANCODE);
            }
        });
    }
