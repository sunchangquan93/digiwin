 ...
 * @date    2017/3/10
 */
public class NoComeUnComActivity extends BaseTitleActivity {
    ...
    private void onitemClick() {
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int position) {
                ...
                showLoadingDialog();
                logic = CommonLogic.getInstance(activity, module, mTimestamp.toString());
                logic.getSum(map, new CommonLogic.GetSumListener() {
                    @Override
    ...
    private void toCommit(Serializable list) {
        ...
        bundle.putSerializable(CommonTwoCommitActivity.COMMITLIST, list);
        bundle.putString(NoComeUnComActivity.MODULECODE,module);
        ActivityManagerUtils.startActivityForBundleData(activity, CommonTwoCommitActivity.class, bundle);
        dismissLoadingDialog();
    }
