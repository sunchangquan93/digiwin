...
import digiwin.smartdepot.module.activity.purchase.purchaseinstore.PurchaseInStorageScanActivity;
 ...
 * @date 2017/3/13
 */
public class SaleOutletSumActivity extends BaseTitleActivity {
    ...
    private void commitData() {
        ...
        commonLogic.commit(map, new CommonLogic.CommitListener() {
            ...
            public void onSuccess(String msg) {
               ...
               // adapter = new PurchaseInStorageSumAdapter(pactivity, new ArrayList<PostMaterialOrderSumData>());
   ...
   static String LIST="list";
    ...
    private void initData() {
        ...
        adapter = new PurchaseInStorageSumAdapter(activity, sumDataList);
        ryList.setAdapter(adapter);
        try {
    ...
    public void onItemClick() {
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int position) {
                ...
                ActivityManagerUtils.startActivityBundleForResult(activity, PurchaseInStorageScanActivity.class, bundle, SCANCODE);
            }
        });
    }
    ...
    public void upDateList() {
        ...
        map.put("receipt_date ", orderData.getCreate_date());
        AccoutBean accoutBean = LoginLogic.getUserInfo();
        String wareout = "";
        if (null != accoutBean) {
            wareout = accoutBean.getWare();
        }
        showLoadingDialog();
        map.put("warehouse_out_no", wareout);
//        commonLogic.getOrderSumData(map, new CommonLogic.GetOrderSumListener() {
//            @Override
