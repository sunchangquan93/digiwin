...
import digiwin.smartdepot.module.activity.produce.distribute.DistributeActivity;
...
public class DistributeSumAdapter extends BaseRecyclerAdapter<DistributeSumShowBean> {
    ...
    protected void bindData(RecyclerViewHolder holder, int position, final DistributeSumShowBean item) {
        ...
        if (numb2 == 0) {
            ...
            holder.setTextColor(R.id.tv_wait_recheck_numb, mContext.getResources().getColor(R.color.red));
            ...
            holder.setTextColor(R.id.tv_wait_recheck_numb, mContext.getResources().getColor(R.color.outside_yellow));
            ...
            holder.setTextColor(R.id.tv_wait_recheck_numb, mContext.getResources().getColor(R.color.Base_color));
