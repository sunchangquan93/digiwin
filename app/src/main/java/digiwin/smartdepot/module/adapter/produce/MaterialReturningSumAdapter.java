...
public class MaterialReturningSumAdapter extends BaseRecyclerAdapter<SumShowBean> {


    public MaterialReturningSumAdapter(Context ctx, List<SumShowBean> list) {
        super(ctx, list);
    }

    @Override
    protected int getItemLayout(int viewType) {
        return R.layout.ryitem_materialreturning;
    }
    ...
    protected void bindData(RecyclerViewHolder holder, int position, SumShowBean item) {
        ...
        holder.setText(R.id.tv_model,item.getUnit_no());
