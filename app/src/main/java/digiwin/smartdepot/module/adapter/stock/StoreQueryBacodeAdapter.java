 ...
 * @date    2017/3/22
 */
public class StoreQueryBacodeAdapter extends BaseRecyclerAdapter<ListSumBean>{
    public StoreQueryBacodeAdapter(Context ctx, List<ListSumBean> list) {
        super(ctx, list);
    }

    @Override
    protected int getItemLayout(int viewType) {
        return R.layout.ryitem_store_query_barcode;
    }
